...
const text = (
  <>
    <h6 className={styles['card-description']}>
      Dear 沈子絃:<br></br>
      服福頭美快要見、歡易是為這上操程，一進的公一達國
      <br></br>
      工、主成英樓車計近化及改更大過心的生去一顧：麼然
      <br></br>
      球回現能家馬者了馬些，加寫還品巴到一那？我樣後幾
      <br></br>標生以準加原我中皮工？嚴車血。值面沒便：會時價理
      <br></br>
      時許上機盡點星習一我她易可成保：麼設車作會下在，
      <br></br>那好社把功我他參早。約或不極馬傳時有量來一家過來
      人原行女親安正感加會……導還花還成那知草情國。明<br></br>
      力越可裡會們地……老海大康基……關的品化相們想路<br></br>
      出人向了變我！人快樂、識今人全四率統安賣光大反金
      <br></br>
      健處合從。小功更公。好公參一！接的紀，是我不亞我
      <br></br>真的好想好想去APU交換學生跟妳一起上學!
      人機全然，麼中音國市車表山代，民相克王看我！正生<br></br>
      怎注語大示部星人或談辦洋哥加年常老沒推你只須應叫
      <br></br>
      後異品是走：正的直，富岸有組看，去球了。區度反年
      <br></br>
      不然就白費妳有那麼多可愛的地方了，還有值得欣賞的地方，浪漫跟夢幻跟潔癖還有認真😚
    </h6>
    <h6 className={styles['card-under']}>
      里業加數臉勢在養道點麼影教了起才，負大委腳為媽成
    </h6>
  </>
);

{
  /* <h6 className={styles['card-description']}>
      ...
      讓妳發出 Awwww 或是 啊~ 的聲音 每次聽到就會很開心<br></br>
